...
- 修改图书信息。如果未选中图书或附加参数重复或附加参数内容为空或将 ISBN 改为原来的 ISBN 或 Keyword 包含重复信息段则 fail，否则修改四个文件和 stack.data。
- 图书进货。如果未选中图书或购入数量为非正整数或交易总额为非正数着 fail，否则修改四个文件和 stack.data。
